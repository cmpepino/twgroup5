...
@Entity
@Table(name = "JOBS", schema = "HR") // ojo si nos conectamos con el usuario "system" en vez de JOBS se debe poner
									// HR.JOBS
public class Trabajo implements Serializable {

	/**
	 * indica la version de la clase 
	 * Sirve, en aplic distribuidas (RMI), para que
	 * las maquinas q se comunican sepan que estan trabajando con la misma version
	 * de la clase
	 */
	...
	// ---- CONSTRUCTOR -----
	//  debe tener, si o si, un constructor sin argumento
	public Trabajo() {
